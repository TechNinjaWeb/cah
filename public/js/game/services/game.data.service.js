game.service('GameData', function($http, $resource, $q){
	...
	var resource = $resource('//localhost:4000/GameData/:id', {
		id: '@id'
	}, {
		getAll: {
            method: 'GET',
	...
	// 		return resource.getAll({}, function(res){
	...
	// 		var deferred = $q.defer();
	// 		var query = new resource({username: params.username, gameData: params.gameData});
	// 		query.$save(function(res){
	// 			return deferred.resolve(res);
	// 		});
	// 		return deferred.promise;
	// 	},
	// 	updatePost: function(index, username, gameData) {
	// 		var deferred = $q.defer();
	// 		this.Resource.update({id: this.data[index]._id, username: username, gameData: gameData}, function(res){
	// 			console.log("Deffering Res", res);
	// 			return deferred.resolve(res);
	// 		});
	// 		return deferred.promise;
	// 	},
	// 	changeParam: function(index, prop, val) {
	// 		var deferred = $q.defer();
	// 		var id = this.data[index]._id;
	// 		this.Resource.get({id: id}, function(res){
	// 			console.log("Hey Got It!", res);
	// 			return deferred.resolve(res);
	// 		});
			
	// 		return deferred.promise.then(function(res){
	// 			res[prop] = val;
	// 			console.log("Setting Porperty", prop, "To Val", val, res);
	// 			return res.$update({id: id}, function(res){return res});
	// 		});
	// 	},
	// 	echoList: function() {
	// 		return this.data;
